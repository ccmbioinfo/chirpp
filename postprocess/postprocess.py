...
class PostProcess:
    def __init__(self, raw_notes, inference_notes, params):
        ...
        merged = merged.groupb(["CSN", "MRN", "Arrival Date", "Arrival Time"])
        ...
        for _, data in merged:
            ...
            group_df["Problem List"]=data["Problem Llist"].drop_duplicates()
    ...
    def autofill(self):
        ...
        problems = self.sheet2["Note Text"].to_list()
        ...
        autofill_cols["IN"] = get_intent(self.sheet2, self.params["intent_filters"], self.params["filter_order"])

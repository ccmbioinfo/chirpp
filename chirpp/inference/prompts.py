...
is missing from the data. Do not present additional information or encouraging, helpful messages
""",



"location" : """For the clinical note provided below indicate where the incident happened 
using the following codes:
	...
	23: someone else's dormitory, school boarding or hostel, 
	...
	42: school or kindergarten, 
	43: tertiary adult education for example university or military college, 
	...
	79: facility for recreation like arcade, bowling alley, bingo hall, 
	81: highway, 
	...
	94: airport, train/bus/subway station ferry terminal, 
	95: service or gas station for automotive, 
	96: warehouse, 
	97: office building, 
	...
	141: remote undeveloped place, swamp, snowmobile track, 
...
"area" : """
For the clinical note provided below indicate the area where the incident happened 
using the following codes:
...
"io" : """
For the clinical note provided below indicate the area where the incident happened indoors or
...
"ampm" : """
For the clinical note provided below indicate the area where the incident happened in the am
or pm
...
like noon, midnight use time representations of it instead like 12:00 or 24:00. The time format should be in 24hr time. 
...
"date" : """
For the clinical note provided below indicate the the relative date the injury happened. Use 0 for today, -1
...
"summary" : """
Summarize the clinical note provided below in less than 50 words. Do not include names due to privacy concerns. Instead just say patient. 
Do not include any information about the patients vitals, immunizations, treatments mentioned in the text. 
Only describe why they have come to the emergency department and the circumstances of the presentation. 
Whenever available provide dates, locations and people involved without mentioning their names (e.g. dad, mom, grandma etc.). 
If mentioned, describe the body parts and the natures of injury for the presentation. If this is a not an injury related to 
self harm indicate where the injury happened. If they are not mentioned just summarize the complaints by the patient or 
his/her family do not explain your reasoning, do not tell me what you are about to do, do not tell what you are asked 
to do or how you are going to do it. Do not include any additional information, just present the summary and nothing else. 
...
"sports" : """
For the clinical note provided below indicate whether the injury happened during an organized sports activity. These include team practices, matches 
competitions and other sports activities where there is an employee (like a coach) or a referee. Use the following codes to indicate the the kind
of activity. 
...
"substance" : """
For the clinical note provided below indicate whether any kind of substance was related to the injury. These include overdoses (intentional and not
...
alcohol, household items, venomous animals, poisonous plants and chemicals (industrial, household etc.). Use the following codes to indicate the presence
of substances:

	1: yes
	2: no

If the response is yes also indicate the name of the substance. If a substance is named as part of the patient's treatment in the ED do 
not include that substance. If the name of the substance is not mentioned use "unknown", if substances do not play a part in the injury 
return "N/A". If there is more than one substance involved present them as comma separated values. 

Your response should have the following structure:

\\{"sub":<1 or 2>, 
  "sub_id":<name of the substance(s) i.e. sub1, sub2 etc. or unknown or "N/A" if sub is 1>\\}
...
"safety" : """
For the clinical note provided below, indicate whether there were any safety devices. Include up to 5 devices. The devices can be implied (i.e. a person 
